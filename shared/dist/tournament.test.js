...
function createMockTeam(id, elo = 1600) {
    return {
        id,
        name: `Team ${id}`,
        fifaRanking: 10,
...
describe('Tournament Rules & Matchups', () => {
    ...
    it('correctly aggregates player tournament statistics from simulated matches', () => {
        ...
        Object.values(GROUPSTAGE_GROUPS).flat().forEach(id => {
            ...
            mockTeams[id].players = [
                { id: 1, name: 'Scorer Player', age: 25, position: 'FW', club: 'FC Mock', teamId: id, number: 9, staminaState: 100, yellowCards: 0, redCarded: false, injured: false, attributes: {} },
                { id: 2, name: 'Assister Player', age: 26, position: 'MF', club: 'FC Mock', teamId: id, number: 10, staminaState: 100, yellowCards: 0, redCarded: false, injured: false, attributes: {} },
                { id: 3, name: 'Carded Player', age: 27, position: 'DF', club: 'FC Mock', teamId: id, number: 4, staminaState: 100, yellowCards: 0, redCarded: false, injured: false, attributes: {} },
            ];
        });
        const state = initializeTournament(1, "World Cup 2026", mockTeams);
    ...
    it('correctly manages player fatigue, morale, suspensions, and injuries after a match', () => {
        const mockTeams = {};
        const player1 = { id: 1, name: 'Player A', age: 25, position: 'FW', club: 'FC Mock', teamId: 'FRA', number: 9, staminaState: 100, yellowCards: 0, redCarded: false, injured: false, attributes: { stamina: 70 } };
        const player2 = { id: 2, name: 'Player B', age: 26, position: 'MF', club: 'FC Mock', teamId: 'FRA', number: 10, staminaState: 100, yellowCards: 0, redCarded: false, injured: false, attributes: { stamina: 80 } };
        const player3 = { id: 3, name: 'Player C', age: 27, position: 'DF', club: 'FC Mock', teamId: 'FRA', number: 4, staminaState: 100, yellowCards: 0, redCarded: false, injured: false, attributes: { stamina: 90 } };
        const awayPlayer = { id: 4, name: 'Opponent Player', age: 25, position: 'FW', club: 'FC Mock', teamId: 'ENG', number: 9, staminaState: 100, yellowCards: 0, redCarded: false, injured: false, attributes: { stamina: 75 } };
